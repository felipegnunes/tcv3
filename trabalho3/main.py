...
def main():
	...
	#ensemble = Ensemble(input_shape = X.shape[1: ], num_classes = num_classes, num_models = 21, batch_size = 1250)
	#ensemble.train(X = X, y = y, epochs_per_model = 200, train_rate = 0.8)
